...
public class FtdzendeskPlugin: NSObject, FlutterPlugin {
  var chatAPIConfig: ChatAPIConfiguration?
  
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "ftdzendesk", binaryMessenger: registrar.messenger())
    let instance = FtdzendeskPlugin()
